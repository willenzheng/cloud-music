...
<template>
  <div class="index">
    ...
    <!-- 播放控制组件 start -->
    <cover
      @click="isPlayPageShow = true"
      :style="
        isPlayPageShow
          ? 'left: 50%;transform: translateX(-50%);bottom: 50%;translateY(50%);width: 200px;height: 200px;'
          : null
      "
    />
    ...
    >
      <van-tabbar-item v-for="item in tabbarList" :key="item.name" :to="item.route" replace>
        <template #icon>
